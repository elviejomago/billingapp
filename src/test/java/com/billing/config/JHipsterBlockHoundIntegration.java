...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.billing.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.billing.security.DomainUserDetailsService", "createSpringSecurityUser");
